...
interface Lead {
  ...
  message?: string; // Holds hair loss stage + willing-to-visit for sales leads
  consent: boolean;
  source?: string;
  formName?: string;
  pageUrl?: string;
...
export default function SalesLeadsDashboard({
  ...
  /* ---------- Treatment options — derived from the actual leads captured ---------- */
  const treatmentOptions = Array.from(
    new Set(
      leads
        .map((l) => l.treatment || l.procedure)
  ...
  const updateLeadStatus = async (id: string, status: UIStatus) => {
    try {
      ...
      console.error("Error updating sales lead status:", error);
    }
  };
  ...
  const exportToCSV = () => {
    const headers = [
      "Name", "Phone", "Email", "Concern", "Details",
          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            <div className="flex flex-col gap-2">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <CardTitle className="flex items-center gap-2 text-xl sm:text-2xl lg:text-3xl font-bold dark:text-white">
                    <ShoppingBag className="h-6 w-6 text-[#dc2626]" />
                    Sales Page Leads
                  </CardTitle>
                  <CardDescription className="text-sm sm:text-base dark:text-gray-400">
                    Manage and track leads captured by the sales landing page
                  </CardDescription>
                </div>
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button
                    onClick={exportToCSV}
                    size="sm"
                    className="flex-1 sm:flex-none bg-[#dc2626] hover:bg-[#b91c1c] text-white"
                  >
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-6 gap-3 p-3 sm:p-4 bg-gray-50/50 dark:bg-gray-800/50 rounded-lg border dark:border-gray-700">
              <div className="relative lg:col-span-2">
                ...
                <Input
                  placeholder="Search name, phone, email, concern..."
                  value={searchTerm}
              ...
              <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto text-sm">
                  {searchTerm || statusFilter !== "all" || treatmentFilter !== "all" || dateFilter !== "all"
                    ...
                    : "No sales page submissions have come in yet"}
                </p>
              </div>
            ) : (
                    ...
                    >
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        {(lead.treatment || lead.procedure) && (
                          <div className="flex items-center gap-2">
                            <span className="font-medium dark:text-gray-300">Concern:</span>
                            <span className="dark:text-gray-300">{lead.treatment || lead.procedure}</span>
                          </div>
                        )}
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-1 gap-3 text-sm">
                              <div>
                                ...
                                <p className="text-gray-600 dark:text-gray-300">{lead.formName || "Sales Landing Page"}</p>
                              </div>
                              <div>
                              ...
                              {lead.message && (
                                <div>
                                  <p className="font-medium text-gray-700 dark:text-gray-400">Details</p>
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50 dark:bg-gray-800 border-b dark:border-gray-700">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left min-w-[180px] dark:text-gray-300">Concern</th>
                    <th className="px-4 py-3 text-left min-w-[220px] dark:text-gray-300">Details</th>
                      ...
                      return (
                        <Fragment key={lead.id}>
                          ...
                          >
                            ...
                            <td className="px-4 py-3">
                              <span className="dark:text-gray-300 text-xs truncate block max-w-[220px]">
                                {lead.message || "-"}
                              </span>
                            </td>
                            <td className="px-4 py-3">
                                  ...
                                  <div>
                                    ...
                                    <div className="space-y-2 text-sm">
                                      ...
                                      <div>
                                        ...
                                        <span className="dark:text-gray-300">{lead.formName || "Sales Landing Page"}</span>
                                      </div>
                                      <div>
