...
import { CONCERN_OPTIONS } from "@/components/chatbot/bot-config";
...
/* ---------- Treatment Options (kept in sync with the chatbot's concern list) ---------- */
const TREATMENT_OPTIONS = CONCERN_OPTIONS;
...
/* ---------- Component ---------- */
export default function ChatbotLeadsDashboard({
  initialLeads = [],
  autoRefresh = false,
  ...
  const exportToCSV = () => {
    const headers = [
      "Name", "Phone", "Email", "Concern", "PIN Code",
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  ...
                  <CardDescription className="text-sm sm:text-base dark:text-gray-400">
                    Manage and track leads captured by the website chatbot
                  </CardDescription>
                </div>
              ...
              <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto text-sm">
                  {searchTerm || statusFilter !== "all" || treatmentFilter !== "all" || dateFilter !== "all"
                    ...
                    : "No chatbot conversations have been completed yet"}
                </p>
              </div>
            ) : (
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-1 gap-3 text-sm">
                              <div>
                                ...
                                <p className="text-gray-600 dark:text-gray-300">{lead.formName || "Adgro Chatbot"}</p>
                              </div>
                              <div>
                                  ...
                                  <div>
                                    ...
                                    <div className="space-y-2 text-sm">
                                      ...
                                      <div>
                                        ...
                                        <span className="dark:text-gray-300">{lead.formName || "Adgro Chatbot"}</span>
                                      </div>
                                      <div>
